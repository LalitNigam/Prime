...
const Section3 = () => {
  return (
    <div className='w-screen h-screen relative overflow-hidden bg-rose-200'>
      {/* Blur  */}
      <div className="absolute top-0 left-0 h-full ms:w-60 w-15 bg-gradient-to-l from-0 to-black/20 backdrop-blur-[2px] pointer-events-none z-600"></div>
      <div className="absolute top-0 right-0 h-full md:w-60 w-15 bg-gradient-to-r from-0 to-black/20 backdrop-blur-[2px]  pointer-events-none z-600"></div>
