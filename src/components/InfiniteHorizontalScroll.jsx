...
const users = [
  ...
  },
  {
    ...
    profilePic: "https://imgs.search.brave.com/VEeFSURPYtssO14skFj7_0Dw13SUzMhbScdjrFIEVXc/rs:fit:500:0:1:0/g:ce/aHR0cHM6Ly9zdGF0/aWMtY3NlLmNhbnZh/LmNvbS9ibG9iLzIx/MjA5NDYvMTYwMHct/RVc0Y2dnWGtnYmMu/anBn"
  },
  {
    name: "Priya Patel",
    review: "Tasted amazing highly recommend",
    profilePic: "https://imgs.search.brave.com/PaqPNW1DCPe5JO3_Fe7UVpRpEaVXAM_E9KUIH9fLxOo/rs:fit:500:0:1:0/g:ce/aHR0cHM6Ly9zdGF0/aWMtY3NlLmNhbnZh/LmNvbS9ibG9iLzIx/MjA5NTYvMTYwMHct/ZlZ5a3VKWkprLTAu/anBn"
  },
  {
    name: "Priya Patel",
...
function ReviewCard({ name, review, profilePic }) {
  return (
    <div className="min-w-[240px] max-w-sm mx-2 bg-rose-200 rounded-xl shadow-md flex items-center space-x-4 p-4">
      <img className="h-12 w-12 rounded-full border-2 border-yellow-400" src={profilePic} alt={name} />
      <div>
